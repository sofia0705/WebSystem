...
<head>
    ...
    <title>WebSysten-Actualizacion</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">Actualiza tus datos?</h1>
                                        <p class="mb-4">Actualiza tus datos, si es requerido actualizar algunos de ellos!</p>
                                    </div>
                                    <form class="user">
                                   ...
                                   <div class="form-group row">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <a href="<?= base_url('Reactualizacion/actualizarDatos') ?>" class="btn btn-primary btn-user btn-block">
                                            Actualiza!
                                        </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url('Registro/guardar') ?>">Crear cuenta!</a>
                                    </div>
                                    <div class="text-center">
